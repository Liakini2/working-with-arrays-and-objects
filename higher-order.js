...
let orderTotals = orders.map(
  (order)=>{
    //takes the price and adds the price multiplied by the tax
...
let bobsTotal = purchases.reduce(
  function (acc, curr){
    ...
    //acc is the running total or accumulator curr is object that we're looping over from the array  
    if(curr.owner === "Bob"){
